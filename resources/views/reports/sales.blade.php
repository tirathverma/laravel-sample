    ...
    <section class="wrapper main-wrapper row" style=''>
        <div class="col-xs-12 wrapper-box">
            ...
            <div class=" pull-left">
                ...
                <td style="font-size: 18px; font-weight: 500;" class="or">OR</td>
                ...
                <tbody>
                    ...
                    <tr id="results">
                        ...
                        <td>
                            ...
                            <a href="{{URL::to('reports/customers')}}?time_period={{Request::input('time_period')}}&sd={{Request::input('sd')}}&ed={{Request::input('ed')}}&customer={{$value->customer->id}}&paidstatus={{Request::input('paidstatus')}}&search=Search"> {{ ($value->customer->name)}} </a>
                        ...
                        <td>
                            ...
                            foreach ($value->invoiceItem as $item) {
                                ...
                                $child_data .= '<tr><td>' . $no . '</td><td>' . $item->stock['name'] . '</td><td>' . number_format($item->stock['vintage'], 2, '.', '') . '</td><td>' . $item->stock['size'] . '</td><td>' . $item->stock['owc'] . '</td><td>' . $item->quantity . '</td><td>' . '$' . number_format($item->cost_hkd, 2, '.', '') . '</td><td>' . '$' . number_format($item->HKD_price, 2, '.', '') . '</td><td>' . '$' . number_format($item->HKD_price * $item->quantity, 2, '.', '') . '</td></tr>';
                            }
