                            ...
                            <table class="table manage_grid">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class='form-control qty' size='1' value="{{($value->quantity)}}" name="qty[{{$value->product_id}}]" remaining_qty="{{($value->stock->qty + $value->quantity ) }}" onkeypress='return isNumberKey(event)' max="99999"></td>
